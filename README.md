...
| [Azure Web App for Containers — Docker](./deployment/azure-docker-web-app.md) | Same app but Dockerised — multi-stage build, ghcr.io registry, service principal auth. Covers `WEBSITES_PORT`, why Container Apps doesn't work on student subscriptions, and custom domain setup. |
